    ...
    while True:
        ...
        try:
            ...
            for motor_id, angle in zip(MOTOR_IDS, angle_vals):
                ...
                # print(f"Read present position status: {dxl_comm_res}")
                # print(f"Dynamixel ID: {motor_id}, Present Pos: {dxl_present_pos}, Target Pos: {dxl_position}")
